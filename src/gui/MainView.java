...
public class MainView extends javax.swing.JFrame {
        ...
        jPanel2Layout.setHorizontalGroup(jPanel2Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(buttonNewTask, GroupLayout.DEFAULT_SIZE, 110, Short.MAX_VALUE))
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                    .addComponent(buttonTaskUp, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(buttonTaskDown, GroupLayout.DEFAULT_SIZE, 110, Short.MAX_VALUE))
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
	...
	private void setTextToComponents() {
		...
		menuItemFile.setToolTipText(tr.menuItemFile);
		menuItemNewTaskFile.setText(tr.menuItemNewTaskFile);
		menuItemNewTaskFile.setToolTipText(tr.menuItemNewTaskFile);
		menuItemOpenFile.setText(tr.menuItemOpenFile);
		menuItemOpenFile.setToolTipText(tr.menuItemOpenFile);
		menuItemSaveTasks.setText(tr.menuItemSaveTasks);
		menuItemSaveTasks.setToolTipText(tr.menuItemSaveTasks);
		menuItemSaveTasksAs.setText(tr.menuItemSaveTasksAs);
		menuItemSaveTasksAs.setToolTipText(tr.menuItemSaveTasksAs);
		menuItemExit.setText(tr.menuItemExit);
		menuItemExit.setToolTipText(tr.menuItemExit);
		
		menuItemHelp.setText(tr.menuItemHelp);
		menuItemHelp.setToolTipText(tr.menuItemHelp);
		menuItemAbout.setText(tr.menuItemAbout);
		menuItemAbout.setToolTipText(tr.menuItemAbout);
		menuItemTranslations.setText(tr.menuItemTranslations);
		menuItemTranslations.setToolTipText(tr.menuItemTranslations);
		
		buttonNewTask.setText(tr.buttonNewTask);
		buttonNewTask.setToolTipText(tr.buttonNewTask);
		buttonRemoveTask.setText(tr.buttonRemove);
		buttonRemoveTask.setToolTipText(tr.buttonRemove);
		buttonTaskUp.setText(tr.buttonUp);
		buttonTaskUp.setToolTipText(tr.buttonUp);
		buttonTaskDown.setText(tr.buttonDown);
		buttonTaskDown.setToolTipText(tr.buttonDown);
		buttonIncrPriority.setText("+ " + tr.buttonPriority);
		buttonIncrPriority.setToolTipText("+ " + tr.buttonPriority);
		buttonDecrPriority.setText("- " + tr.buttonPriority);
		buttonDecrPriority.setToolTipText("- " + tr.buttonPriority);
		buttonShowAll.setText(tr.buttonShowAll);
		buttonShowAll.setToolTipText(tr.buttonShowAll);
		buttonHideAll.setText(tr.buttonHideAll);
		buttonHideAll.setToolTipText(tr.buttonHideAll);
		
		buttonTaskDone.setText(tr.buttonTaskDone);
		buttonTaskDone.setToolTipText(tr.buttonTaskDone);
		buttonTaskWorking.setText(tr.buttonTaskWorking);
		buttonTaskWorking.setToolTipText(tr.buttonTaskWorking);
		buttonTaskHold.setText(tr.buttonTaskHold);
		buttonTaskHold.setToolTipText(tr.buttonTaskHold);
		buttonTaskOnRevision.setText(tr.buttonTaskOnRevision);
		buttonTaskOnRevision.setToolTipText(tr.buttonTaskOnRevision);
		buttonTaskPendingRevision.setText(tr.buttonTaskPendingRevision);
		buttonTaskPendingRevision.setToolTipText(tr.buttonTaskPendingRevision);
		buttonTaskEdit.setText(tr.buttonTaskEdit);
		buttonTaskEdit.setToolTipText(tr.buttonTaskEdit);
		buttonTaskCancel.setText(tr.buttonTaskCancel);
		buttonTaskCancel.setToolTipText(tr.buttonTaskCancel);
		buttonTaskDelete.setText(tr.buttonTaskDelete);
		buttonTaskDelete.setToolTipText(tr.buttonTaskDelete);
		buttonTaskClear.setText(tr.buttonTaskClear);
		buttonTaskClear.setToolTipText(tr.buttonTaskClear);
		buttonTaskReopen.setText(tr.buttonTaskReopen);
		buttonTaskReopen.setToolTipText(tr.buttonTaskReopen);
		
		buttonNewTaskFile.setText(tr.buttonNewTaskFile);
		buttonNewTaskFile.setToolTipText(tr.buttonNewTaskFile);
		buttonOpenTasks.setText(tr.buttonOpenTasks);
		buttonOpenTasks.setToolTipText(tr.buttonOpenTasks);
		buttonSaveTasks.setText(tr.buttonSaveTasks);
		buttonSaveTasks.setToolTipText(tr.buttonSaveTasks);
		buttonSaveTasksAs.setText(tr.buttonSaveTasksAs);
		buttonSaveTasksAs.setToolTipText(tr.buttonSaveTasksAs);
		buttonSetAuthor.setText(tr.buttonSetAuthor);
		buttonSetAuthor.setToolTipText(tr.buttonSetAuthor);
		labelAuthorName.setText(tr.labelAuthorName);
		labelAuthorName.setToolTipText(tr.labelAuthorName);
		labelUnsavedChanges.setText(tr.labelUnsavedChanges);
		labelUnsavedChanges.setToolTipText(tr.labelUnsavedChanges);
		
		labelTaskName.setText(tr.labelTaskName);
		labelTaskName.setToolTipText(tr.labelTaskName);
		labelTaskAuthor.setText(tr.labelTaskAuthor);
		labelTaskAuthor.setToolTipText(tr.labelTaskAuthor);
		labelTaskDate.setText(tr.labelTaskDate);
		labelTaskDate.setToolTipText(tr.labelTaskDate);
		labelTaskDescription.setText(tr.labelTaskDescription);
		labelTaskDescription.setToolTipText(tr.labelTaskDescription);
		labelTaskHistory.setText(tr.labelTaskHistory);
		labelTaskHistory.setToolTipText(tr.labelTaskHistory);
		labelTaskStateText.setText(tr.labelTaskStateText);
		labelTaskStateText.setToolTipText(tr.labelTaskStateText);
